			...
			if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
				...
				else if($step=="421")
				{
					...
					else
					{
						$messages = [
										'type' => 'text',
										'text' => "กรุณาพิม # หรือ * เท่านั้น 66666"
									];
				...
				else if($step=="4222223")
				{
					...
					else
					{
						$messages = [
										'type' => 'text',
										'text' => "กรุณาพิม # หรือ * เท่านั้น 77777"
									];
				...
				else if($step=="4222")#ชื่อเจ้าของบัญชี
				{
					...
					if($user_id=="not")#ครั้งเเรกไม่มีประวัติถอนเงินด้วย บัญชี
					{
						...
						$messages = [
								'type' => 'text',
								'text' => "ชื่อเจ้าของบัญชีธนาคารของคุณคือ\n คุณ ".$text."\n\nถูกต้องกด #\nเเก้ไขกด *"
							];
					}
					else
					{
				...
				else if($step=="42221")#ยืนยันชื่อเจ้าของบัญชี
				{
					...
					else
					{
						$messages = [
										'type' => 'text',
										'text' => "กรุณาพิม # หรือ * เท่านั้น 88888"
									];
				...
				else if($step=="422221")#ยืนยันชื่อธนาคาร
				{
					...
					else
					{
						$messages = [
										'type' => 'text',
										'text' => "กรุณาพิม # หรือ * เท่านั้น 99999"
									];
				...
				else if($step=="4221")#ยืนยันบัญชี
				{
					...
					else
					{
						$messages = [
										'type' => 'text',
										'text' => "กรุณาพิม # หรือ * เท่านั้น 123"
									];
				...
				else if($step=="411")#ถอนเงิน seven มีประวัติ
				{
					...
					else
					{
						$messages = [
										'type' => 'text',
										'text' => "กรุณาพิม # หรือ * เท่านั้น 1234"
									];
				...
				else if($step=="41111")#เช็คจำนวนเงินถอน
				{
					...
					else
					{
						$messages = [
										'type' => 'text',
										'text' => "กรุณาพิม # หรือ * เท่านั้น 33333"
									];
				...
				else if($step=="212")#กรอกจำนวนเงินโอนธนาคาร
				{
					...
					else
					{
						$messages = [
										'type' => 'text',
										'text' => "กรุณาพิม # หรือ * เท่านั้น 4444"
									];
